...
function Login() {
  ...
  return (
    <>
      <div
        className="bg-[#F5E8E4] min-h-screen p-20 "
        style={{
      ...
      >
        <div class="relative flex w-96 flex-col rounded-xl bg-[#411530] bg-clip-border  shadow-md">
          ...
          <div >
          {
            ...
            <div class="text-center mb-6">
              ...
              <p class="dark:text-black-400">
                Your will be signed in few minutes
              </p>
            </div>
            </>: <></>
            }
